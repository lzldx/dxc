...
func defaultNodeConfig() node.Config {
	...
	cfg.IPCPath = "gdxc.ipc"
	return cfg
}

// makeConfigNode loads gdxc configuration and creates a blank node instance.
...
// makeFullNode loads gdxc configuration and creates the Ethereum backend.
