...
// gdxc is the official command-line client for DxChain.
package main
...
const (
	clientIdentifier = "gdxc" // Client identifier to advertise over the network
)
...
// gdxc is the main entry point into the system if no special subcommand is ran.
// It creates a default node based on the command line arguments and runs it in
// blocking mode, waiting for it to be shut down.
func gdxc(ctx *cli.Context) error {
...
func startNode(ctx *cli.Context, stack *node.Node, backend ethapi.Backend) {
	...
	// Create a client to interact with local gdxc node.
